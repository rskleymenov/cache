...
public class ArrayListTest {
    ...
    public void testElementsSpeed() {
        ArrayList<Tuple> randomStrings = getRandomStrings(NUMBER_OF_ELEMENTS);
        ...
        for (int i = 0; i < NUMBER_OF_EXPIREMENTS; i++) {
            ...
            //prepare data
            ArrayList<Tuple> structure = new ArrayList<Tuple>();
    ...
    private ArrayList<Tuple> getRandomStrings(int number) {
        ArrayList<Tuple> randomString = new ArrayList<Tuple>();
