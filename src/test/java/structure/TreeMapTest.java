...
public class TreeMapTest {
    ...
    public void testElementsSpeed() {
        TreeMap<String, Integer> randomStrings = getRandomStrings(NUMBER_OF_ELEMENTS);
        ...
        for (int i = 0; i < NUMBER_OF_EXPIREMENTS; i++) {
            ...
            //prepare data
            TreeMap<String, Integer> structure = new TreeMap<String, Integer>();
            int j = 0;
    ...
    private TreeMap<String, Integer> getRandomStrings(int number) {
        TreeMap<String, Integer> randomString = new TreeMap<String, Integer>();
